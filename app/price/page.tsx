        ...
        <main className='px-6 sm:px-20 w-full sm:w-11/12 max-w-6xl mx-auto'>
            <div className='max-w-xl'>
                ...
                <p className='my-6 text-base text-zinc-500 text[#8b8b94] dark:text-zinc-400 '>
                    Каждый проект крайне индивидуален, поэтому ниже я указал
                    цены за основные пункты. Все подробности по проектам и
                    точные цены обсуждаются более детально при личном контакте.
                </p>
            </div>
