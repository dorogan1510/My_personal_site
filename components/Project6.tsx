...
const Project1 = () => {
    ...
    //text variables
    const h2text = 'Виджет погоды'
    const p2text =
        'Узнай погоду в любой точке мира и посмотри лучшие фото того места, которое ты ввел. '
    const litext1 = 'JS ES6+'
    const litext2 = 'SASS'
    const litext3 = 'Laravel Mix'
    const litext4 = 'Fetch API'

    //url variables
    const githubUrl = 'https://github.com/dorogan1510/weather'
    const externalUrl = 'https://dorogan1510.github.io/weather/'
