...
const LandingPrice = () => {
    ...
    return (
        <div className='p-6 rounded-xl border border-zinc-100 dark:border-zinc-700/40 flex flex-col lg:flex-row justify-between items-center gap-4 shadow dark:shadow-[0_1px_3px_0_rgba(255, 255, 255, 0.2)]'>
            <div className='max-w-lg flex-2'>
                ...
                <p className='my-6 text-base text-zinc-500 text[#8b8b94] dark:text-zinc-400'>
                    Данный вариант подойдет для того, кому нужен простой
                    одностраничный сайт со всей информацией в одном месте.
                </p>
                <div className='mb-4'>
            ...
            >
                <Modal.Body className=' rounded-xl bg-white p-8 ring-1 ring-zinc-900/5 dark:bg-zinc-900 dark:ring-zinc-800'>
                    <div ref={modalRef}>
                        <h3 className='mb-6 text-xl font-bold text-zinc-800 dark:text-zinc-100 text-center'>
