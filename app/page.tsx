            ...
            <div className='mb-20 flex flex-col lg:flex-row justify-between items-center gap-6'>
                <div className='max-w-xl'>
                    ...
                    <p className='my-6 text-base text-zinc-500 text[#8b8b94] dark:text-zinc-400 text-center lg:text-left'>
                        Привет, я сделаю для тебя сайт на любой вкус. Свяжись со
                        мной и мы обсудим все детали Привет, я сделаю для тебя
                        сайт на любой вкус. Свяжись со мной и мы обсудим все
                        детали
                    </p>
                ...
                <div className=' max-w-xs order-first lg:order-last'>
                    <Image
