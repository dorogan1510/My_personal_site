...
const Project1 = () => {
    ...
    //text variables
    const h2text = 'Сайт визитка'
    const p2text =
        'Лендинг для преподавателя английского языка. CSS анимации, адаптивная верстка, вся важная информация на одной странице'
    const litext1 = 'JS ES6+'
    const litext2 = 'SASS'
    const litext3 = 'Laravel Mix'
    const litext4 = 'CSS animations'

    //url variables
    const githubUrl = 'https://github.com/dorogan1510/web_card'
    const externalUrl = 'https://easyenglishyou.ru/morkoovochka'
            ...
            >
                <div className='flex justify-center  text-left '>
                    <section className='flex flex-col items-center text-center'>
                        ...
                        <h2 className='font-medium mb-2  text-zinc-800 dark:text-zinc-100  '>
                            {h2text}
                        </h2>
