...
const Project1 = () => {
    ...
    //text variables
    const h2text = 'Список дел'
    const p2text =
        'Минималистичный список дел с базовым фукционалом и плавными анимациями'
    const litext1 = 'React.js'
    const litext2 = 'Typescript'
    const litext3 = 'React transition group'

    //url variables
    const githubUrl = 'https://github.com/dorogan1510/React_todoList'
    const externalUrl = 'https://gorgeous-quokka-121d0f.netlify.app/'
