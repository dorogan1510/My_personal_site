...
const Project1 = () => {
    ...
    //text variables
    const h2text = 'Сайт для продажи курса английского языка'
    const p2text =
        'Коммерческий лендинг для продажи онлайн курса. Адаптивная и кроссбраузерная верстка.'
    const litext1 = 'JS ES6+'
    const litext2 = 'SASS'
    const litext3 = 'Laravel Mix'

    //url variables
    const githubUrl = 'https://github.com/dorogan1510/English_course'
    const externalUrl = 'https://easyenglishyou.ru/'
