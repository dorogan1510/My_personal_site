...
const Project1 = () => {
    ...
    //text variables
    const h2text = 'Онлайн магазин в тестовом режиме'
    const p2text =
        'Онлайн магазин с фейковым API и базовым функционалом.'
    const litext1 = 'React.js/Mobx'
    const litext2 = 'MaterialUI/SASS'
    const litext3 = 'Axios/Fuse.js'

    //url variables
    const githubUrl = 'https://github.com/dorogan1510/New_online_store'
    const externalUrl = 'https://vocal-donut-4e3013.netlify.app/'
