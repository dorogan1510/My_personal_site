...
const Project1 = () => {
    ...
    //text variables
    const h2text = 'Приложение для учета финансов'
    const p2text = 'Ты всегда будешь оставаться в курсе своих ежедневных трат'
    const litext1 = 'React.js/Redux toolkit'
    const litext2 = 'Typescript'
    const litext3 = 'Material UI'
    const litext4 = 'Framer motion'
    const litext5 = 'Chart.js'

    //url variables
    const githubUrl = 'https://github.com/dorogan1510/react_ts_expense_tracker'
    const externalUrl = 'https://clever-kleicha-fffcdd.netlify.app/'
