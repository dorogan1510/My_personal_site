...
const Project1 = () => {
    ...
    //text variables
    const h2text = 'Злой калькулятор'
    const p2text =
        'Мини игра, где тебе придется пройти небольшой квест, сыграть в игру "Виселица" и наконец получить свой ответ'
    const litext1 = 'React.js'
    const litext2 = 'React-Bootstrap/SASS'
    const litext3 = 'useSound'

    //url variables
    const githubUrl = 'https://github.com/dorogan1510/evil_calculator'
    const externalUrl = 'https://enchanting-eclair-59989f.netlify.app/'
